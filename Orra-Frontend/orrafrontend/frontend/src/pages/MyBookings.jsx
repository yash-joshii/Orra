...
// Temporary static data — will be replaced by bookings pulled from Redux/store
const dummyBookings = [
    {
        id: 1,
        productImage: "/public/drone.avif",
        productName: "DJI Mavic 3 Pro Cinematic",
        startDate: "Oct 12",
        endDate: "Oct, 2026",
        location: "Pune, Maharashtra",
        ownerName: "Alex D.",
        ownerAvatar: "/public/profile1.avif",
        displayStatus: "currently_rented",
    },
    {
        id: 2,
        productImage: "/public/drone.avif",
            ...
            <div className="tabs-change-container absolute top-[150px] left-[385px] text-[#5650cc]">
                <Tabs defaultValue="active_upcoming">
                    <TabsList variant="line">
                        <TabsTrigger value="active_upcoming">Active & Upcoming</TabsTrigger>
                    ...
                    <TabsContent value="active_upcoming" className="flex flex-col mt-[20px] gap-[24px]">
                        {dummyBookings.map((booking) => (
                            <MyBookingsCard key={booking.id} booking={booking} />
                        ))}
                    ...
                    <TabsContent value="awaiting_owner">{/* map bookings with status PENDING */}</TabsContent>
                    <TabsContent value="completed">{/* map bookings with displayStatus "completed" */}</TabsContent>
                    <TabsContent value="cancelled">{/* map bookings with status CANCELLED */}</TabsContent>
                </Tabs>
            </div>
        </div>
    </>
